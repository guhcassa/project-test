			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('dokter/dokter/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('dokter/dokter/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="noktp">No KTP*</label>
								<input class="form-control <?php echo form_error('noktp') ? 'is-invalid':'' ?>"
								 type="text" name="noktp" placeholder="NoKtp" />
